...
using MySettings = StructuredFileDataSourceSettings<CampbellSettings, CampbellAdditionalFileSourceSettings>;
...
public class CampbellTests
{
    ...
    {
        // arrange
        var dataSource = (IDataSource<MySettings>)new Campbell();
